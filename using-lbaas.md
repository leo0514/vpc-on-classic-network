...
More information on granting access is available at [Granting permissions to see account events](/docs/Activity-Tracker-with-LogDNA?topic=Activity-Tracker-with-LogDNA-iam).
